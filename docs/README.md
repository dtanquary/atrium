...
| Aurora | [aurora.md](aurora.md) | `Aurora.swift`, `Resources/aurora-*` | perspective shader sky, photo ground lit by it | knobs, 8 palettes, compare switch | none | 0.6 / 1.0–1.45 |
...
| Fireflies | [fireflies.md](fireflies.md) | `Fireflies.swift` | SpriteKit, painted in shaders and Core Graphics | density | none | 0.5 / 1.45 |
