...
| Rain on Glass | [rain-on-glass.md](rain-on-glass.md) | `Shaders.swift` | shader | none yet | none | 0.45 / 1.40 |
| Aurora | [aurora.md](aurora.md) | `Shaders.swift` | shader | none yet | none | 0.42 / 1.87 |
